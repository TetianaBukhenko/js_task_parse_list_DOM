"use strict";
const convertSalary = (salary)=>+salary.replaceAll("$", "").replaceAll(",", "");
...
function sortList(list) {
    const newList = getEmployees(list).sort((person1, person2)=>convertSalary(person2.salary) - convertSalary(person1.salary)).map((person)=>{
